class Solution { // class Solution 
 public:  // public:
  long long countPaths(int n, vector<vector<int>>& edges) { //long ans countPaths(int n, vector<vector<int>>& edges) 
    long ans = 0; // long ans = 0;
    const vector<bool> isPrime = sieveEratosthenes(n + 1); // const vector<bool> isPrime = sieveEratosThenes(n + 1);
    vector<vector<int>> graph(n + 1); // vector<vector<int>> graph(n + 1);
