class Solution { // class Solution {}
 public: // public:
  vector<int> spiralOrder(vector<vector<int>>& matrix) { // vector<int> spiralOrder(vector<vector<int>>& matrix)
    if (matrix.empty()) // if (matrix.empt())
      return {}; // return {};
    ...
    int r1 = 0; // int r1 = 0;
    int c1 = 0; // int c1 = 0;
    int r2 = m - 1; // int r2 = m -1 ;
    int c2 = n - 1; // int c2 = n -1;
